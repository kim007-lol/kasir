...
<head>
    ...
    <title>@yield('title', 'Login Staf — SmegaMart')</title>
    <!-- Animasi Lokal Ringan & Offline -->
...
<body>
    <div class="auth-card">
        ...
        <div class="auth-logo">
            ...
            <h3>Login Staf</h3>
            <p>Sistem Manajemen & Kasir SmegaMart</p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}" id="loginForm">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="login" id="login"
                    ...
                    value="{{ old('login') }}" placeholder="Masukkan username atau email" required autofocus>
            </div>
